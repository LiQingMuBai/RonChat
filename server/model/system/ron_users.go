...
type RonUsers struct {
	...
	Uid       uint   `json:"uid" form:"uid" gorm:"comment:用户登录名;column:uid;size:191;"`                     //用户登录名
	...
	StreamId  string `json:"streamId" form:"streamId" gorm:"comment:streamId;column:stream_id;size:191;"`  //roomID
